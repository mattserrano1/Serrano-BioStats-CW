...
fat_stats <- bodyfat |> group_by(gender) |>
  summarise(mean_bodyfat = mean(body_fat_percent), 
            sd_bodyfat = sd(body_fat_percent))
```
...
3.  Discuss with your partner:
    ...
    I don't think they meet these assumptions. The Male data set does not seem to have a normal distribution of data, while the female one does appear to have a normal distribution. Their standard deviations are somewhat similar but not sure what actually counts as them being similar. 
