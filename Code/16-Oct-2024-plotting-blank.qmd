...
names() returns the column names of the dataset
you can also use it to assign the names of the columns in a dataset
...
3.  Adjust data types
changing character to factor data, checking for mistakes, changing to date
