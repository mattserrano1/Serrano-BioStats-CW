...
We notice that the slope is: **CHOOSE ONE: POSITIVE (0)**.
...
From four to sixteen arousals

Slope is rise/run, which in this case is about 2 for rise and 12 for run, so we get 1/6 as our guesstimate of the slope.

Eyeballing the plot, we would also guess that the y-intercept is somewhere around 0.25
...
```{r}
autoplot(model_bats, smooth.color = NA)
```

What does this all mean?

Residuals are the distance a point would be from the line of best fit

Top Left:

Straight line means a Line of best fit will be linear

Top Right:

Is our data normally distributed, do the points follow the line

Bottom Left:

Bottom Right:

Are there any points having an out of proportion effect on the analysis
